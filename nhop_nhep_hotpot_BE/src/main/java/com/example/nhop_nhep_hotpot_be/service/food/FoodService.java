...
public class FoodService implements IFoodService {
    ...
    public void copyFoodToFoodDTO(Food food, FoodDTO foodDTO) {
        ...
        setValueOfFoodImgSet(food.getFoodImageSet(), foodDTO.getFoodImgDTOS());
    ...
    @Override
    public Page<FoodDTO> findWithFoodType(Integer foodTypeId, Pageable pageable) {
    Page<Food> foodPage = foodRepository.searchWithType(foodTypeId,pageable);
    List<FoodDTO> foodDTOList = new ArrayList<>();
    FoodDTO foodDTO;
    for (Food food : foodPage){
        foodDTO = new FoodDTO();
        foodDTO.setFoodTypeDTO(new FoodTypeDTO());
        BeanUtils.copyProperties(food.getFoodType(),foodDTO.getFoodTypeDTO());
        BeanUtils.copyProperties(food,foodDTO);
    ...
    return new PageImpl<>(foodDTOList,pageable,foodPage.getTotalElements());
    }
}
