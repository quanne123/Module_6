...
export default function Cart() {
    ...
    const total = (cartDetails || []).reduce((acc, cart) => {
        return acc + cart.quantity * cart.foodDTO.price;
    }, 0);
                                                            ...
                                                            <div key={index}>
                                                                <div className="row mb-4 d-flex justify-content-between align-items-center">
                                                                    <div className="col-md-2 col-lg-2 col-xl-2">
                                                                        <img
                                                                            src={
                                                                                cartDetail.foodDTO.foodImgDTOS[0]
                                                                                    .url
                                                                            }
                                                                    ...
                                                                    <div className="col-md-3 col-lg-3 col-xl-3">
                                                                        <h6 className="text-muted">
                                                                            {
                                                                                cartDetail.foodDTO.foodTypeDTO
                                                                                    .name
                                                                            }
                                                                        </h6>
                                                                        <h6 className="text-black mb-0">
                                                                            <Link
                                                                                to={`/food-detail/${cartDetail.foodDTO.id}`}
                                                                                style={{ textDecoration: "none" }}
                                                                                className="text-black"
                                                                            >
                                                                                {cartDetail.foodDTO.name}
                                                                            </Link>
                                                                        </h6>
                                                                    </div>
